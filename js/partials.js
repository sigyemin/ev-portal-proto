...
(function () {
              ...
              <div class="mega-inner">
                ...
                <div class="mega-columns">
                  <div class="mega-col">
                    ...
                    <ul>
                      <li><a href="index.html?ai=charge#aiSectionAnchor" data-i18n="mega.community.ai.charge">충전 도우미</a></li>
                      <li><a href="index.html?ai=subsidy#aiSectionAnchor" data-i18n="mega.community.ai.subsidy">보조금 도우미</a></li>
                    </ul>
                  </div>
                  <div class="mega-col">
  ...
  const sitemapSections = [
    ...
    { tKey: 'nav.community', cols: [
      { tKey: 'mega.community.ai', items: [['충전 도우미','index.html?ai=charge#aiSectionAnchor','mega.community.ai.charge'],['보조금 도우미','index.html?ai=subsidy#aiSectionAnchor','mega.community.ai.subsidy']] },
