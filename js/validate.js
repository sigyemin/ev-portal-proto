	...
	function validate(form) {
		...
		for (var i = 0; i < form.elements.length; i++) {
			...
			obj = form.elements[i];
			if (obj.type != "file") obj.value = trim(obj.value);
			...
			if (obj.type == "text" || obj.type == "textarea" || obj.type == "hidden" || obj.type =="password") {
					...
					if(equals!= null){
							"isValid = isEqualValidate(value,"+ equals + ".value)";
							if(!isValid){
								"var title2 =" +equals+".title;";
			...
			if ((value != "") && (dataType != null)) {
					...
					if (dataType == "date") {
						...
						value = value + "@" + "obj.form." + subfield + ".value" ;
						isValid = isEmail(value);
