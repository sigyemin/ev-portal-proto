	...
	$.fn.fnFileUpload = function(option){
		...
		return this.each(function(i, obj) {
	        ...
	        if(curUrl.indexOf("/user/") < 0) {
				...
				divAreaHtml += "<div class=\"file-up\">";
				
				divAreaHtml += "<label class=\"file\">\n";
	            divAreaHtml += "    <span>파일찾기</span>\n";
	            divAreaHtml += "    <input type=\"file\" class=\"form\" name=\"files"+idx+"\" id=\"fileupload"+idx+"\" data-url=\""+url+"\" multiple  width=\"100%\" />\n";
	            divAreaHtml += "</label>\n";
	            divAreaHtml += "<label class=\"reset\">\n";
	            divAreaHtml += "    <span>초기화</span>\n";
	            divAreaHtml += "    <input type=\"reset\" value=\"\" onclick=\"fnFileListReset('"+idx+"')\" >\n";
	            divAreaHtml += "</label>\n";
				divAreaHtml += "<div class=\"list-box\">\n";
				divAreaHtml += "<ul id=\"uploaded-files"+idx+"\" class=\"list\">\n";
				divAreaHtml += "</ul>\n";
				divAreaHtml += "</div>\n";
				divAreaHtml += "</ul>\n";
				divAreaHtml += "</div>\n";
...
function fnFileListReset(idx){
	...
	console.log("fnFileListReset  idx  :: "+idx);
