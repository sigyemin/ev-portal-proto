/* ============================================================================
   ...
   예외: '서식다운로드'·'사용자매뉴얼' = 신설 항목(badge:'신설') — 시스템관리 > 게시판 관리 > 질의응답(건의사항) 다음 순번
         (ISS-037: 통계 그룹 신설 지표 항목 1건 제거 — 해당 관리자 화면도 IA에서 제외, 파일은 orphan 유지)
         (ISS-039: '사용자매뉴얼' 신설 — 서식다운로드 다음 순번. 관리자는 게시판을 전부 나열하므로
          대민 자료실 4탭 구조와 무관하게 독립 항목. 근거=회의록/통합관리_개발안내_03_사용자매뉴얼_20260722.md)
   실링크 3개(질의응답·서식다운로드·사용자매뉴얼) 외 전부 스텁('준비 중').
...
window.ADMIN_MENU_NTP = [
  ...
  { label:'시스템관리', children:[
    ...
    { label:'게시판 관리', children:[
      ...
      { label:'추석기간 전기차 충전요금 추가할인 알림 관리', href:'admin-board-discount.html', badge:'신설' },
